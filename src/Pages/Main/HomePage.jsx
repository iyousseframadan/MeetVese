          ...
          <div className="relative flex flex-col lg:flex-row items-center justify-between gap-10">
            <div className="space-y-6 max-w-2xl">
              ...
              <p className="text-slate-600 dark:text-[#A8B0C2] text-base md:text-lg leading-relaxed">
                Experience distraction-free collaboration. Review AI-powered
                reports or start a new call in seconds.
              </p>
              <div className="flex flex-wrap gap-4 pt-4">
                ...
                >
                  <BarChart3 size={18} /> View Archives
                </a>
              </div>
            </div>
