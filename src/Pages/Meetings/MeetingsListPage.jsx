    ...
    <div className="min-h-screen bg-slate-50 dark:bg-[#0D0F16] text-slate-900 dark:text-[#F1F5F9] transition-colors duration-300">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-28 pb-16 space-y-8">
        ...
        >
          <div className="space-y-1">
            ...
            <p className="text-slate-500 dark:text-[#A8B0C2] text-sm">
              Review recordings or join live sessions instantly.
            </p>
          </div>
        ...
        <motion.div
          ...
          className="bg-white dark:bg-[#181B26] border border-slate-200 dark:border-[#2A2E3B] p-4 rounded-[2rem] flex flex-col md:flex-row items-center justify-between gap-4 shadow-sm"
        >
        ...
        <div className="grid gap-4">
          {meetings.map((m, idx) => (
            <motion.div
              ...
              className="group bg-white dark:bg-[#181B26] border border-slate-200 dark:border-[#2A2E3B] p-6 rounded-[2.5rem] flex flex-col lg:flex-row items-center justify-between gap-6 hover:border-blue-500 transition-all hover:shadow-2xl hover:shadow-blue-900/10"
            >
              ...
              <div className="flex items-center gap-3 w-full lg:w-auto">
                <a
                  href={`/meetings/${m.id}`}
                  className="flex-1 lg:flex-none text-center px-8 py-3 bg-blue-600 hover:bg-blue-700 text-white text-sm font-bold rounded-2xl transition-all shadow-lg shadow-blue-900/20"
                >
                  Join Call
                </a>
                <a
                  href={`/meetings/${m.id}/reports`}
                  className="flex-1 lg:flex-none flex items-center justify-center gap-2 px-6 py-3 border border-slate-200 dark:border-[#2A2E3B] text-sm font-semibold rounded-2xl hover:bg-slate-50 dark:hover:bg-[#2A2E3B] transition-all"
                >
