      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-16 flex justify-center">
        ...
        >
          <div className="text-center mb-10">
            <div className="inline-flex p-4 bg-blue-800/10 text-blue-800 rounded-2xl mb-4">
              <LogIn size={32} />
            </div>
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-slate-50 dark:bg-[#0D0F16] border border-slate-200 dark:border-[#2A2E3B] rounded-2xl pl-12 pr-4 py-3.5 text-sm focus:border-blue-800 outline-none transition-all"
                />
              </div>
            </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-blue-800 hover:bg-blue-800 disabled:opacity-70 text-white font-bold py-4 rounded-[1.5rem] shadow-xl shadow-blue-900/20 transition-all flex items-center justify-center gap-2 active:scale-95"
            >
              {loading ? (
                "Authenticating..."
              ) : (
