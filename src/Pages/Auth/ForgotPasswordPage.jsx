        ...
        >
          ...
          <form className="space-y-6">
           ...
           <Link to="/otp-verification">
            <button
              type="submit"
              className="w-full bg-blue-800 hover:bg-blue-800 text-white font-bold py-4 rounded-[1.5rem] shadow-xl shadow-blue-900/20 transition-all flex items-center justify-center gap-2 active:scale-95"
            >
